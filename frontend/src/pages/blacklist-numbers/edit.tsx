...
import { ArrowLeft, Phone, MessageSquare, User, Save, AlertCircle, Trash2 } from 'lucide-react';
...
export default function BlacklistNumbersEdit() {
    ...
    useEffect(() => {
        const fetchBlacklistNumber = async () => {
            ...
            try {
                const blacklistData = await apiClient.get<BlacklistNumber>(`/blacklist-numbers/${id}`);
                setBlacklistNumber(blacklistData);
                setData({
                    number: blacklistData.number,
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            await apiClient.put(`/blacklist-numbers/${id}`, data);
            navigate('/blacklist-numbers');
        } catch (error) {
            console.error('Error updating blacklist number:', error);
    ...
    const handleDelete = async () => {
        try {
            await apiClient.delete(`/blacklist-numbers/${id}`);
            navigate('/blacklist-numbers');
        } catch (error) {
            ...
            <div className="flex h-full flex-1 flex-col gap-4 rounded-xl p-4">
                ...
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h1 className="text-3xl font-bold tracking-tight">Edit Blacklist Number</h1>
                            <p className="text-muted-foreground">
                                Modify blacklist number details
                            </p>
                        </div>
                    </div>
                    <Button
                        ...
                        <CardContent>
                            <form onSubmit={handleSubmit} className="space-y-6">
                                ...
                                <Alert>
                                    ...
                                    <AlertDescription>
                                        <strong>Important:</strong> Changes to blacklist numbers will affect 
                                        SMS delivery immediately. Make sure the information is correct before saving.
                                    </AlertDescription>
                                </Alert>
            ...
            <Dialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
                <DialogContent className="sm:max-w-md">
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            Are you sure you want to delete this blacklist number? This action cannot be undone.
                        </DialogDescription>
                    </DialogHeader>
