...
import { simCardsService, type CreateSimCardData } from '@/services/sim-cards';
...
export default function SimCardCreate() {
    ...
    const [formData, setFormData] = useState<CreateSimCardData>({
        imei: '',
        iccid: '',
        msisdn: '',
        operator: '',
    ...
    const handleInputChange = (field: keyof CreateSimCardData, value: any) => {
        setFormData(prev => ({
            ...prev,
            [field]: value,
        }));
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            setLoading(true);
            await simCardsService.createSimCard(formData);
            ...
            <div className="space-y-6">
                ...
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h1 className="text-2xl font-bold tracking-tight">Create SIM Card</h1>
